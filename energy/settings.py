...
SECRET_KEY = "django-insecure-d^rj2v%$tvsd#3&8lsws27ksou-79m!dzpbx*k9l!%0rubxs#("
...
# For production use (optional, if using Whitenoise)
...
LOGIN_REDIRECT_URL = 'adm_dashboard'  # Where to redirect after login
